...
button1 = Button(frame3, text="Send to Front", command= lambda: setSide("front","f"))
button1.grid(row=0, column=0, padx=2, pady=2)
button2 = Button(frame3, text="Send to Back", command= lambda: setSide("back","b"))
button2.grid(row=1, column=0, padx=2, pady=2)
button3 = Button(frame3, text="Send to Up", command= lambda: setSide("up","u"))
button3.grid(row=2, column=0, padx=2, pady=2)
button4 = Button(frame3, text="Send to Down", command= lambda: setSide("down","d"))
button4.grid(row=0, column=1, padx=2, pady=2)
button5 = Button(frame3, text="Send to Left", command= lambda: setSide("left","l"))
button5.grid(row=1, column=1, padx=2, pady=2)
button6 = Button(frame3, text="Send to Right", command= lambda: setSide("right","r"))
